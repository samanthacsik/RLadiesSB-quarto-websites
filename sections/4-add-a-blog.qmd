...
8. **Configure your blog post.** You can add a variety of different options to the YAML section of index.qmd. Here are my go-to options:
...
::: {.callout-note}
## Repeat steps 1-8 to add a new blog post
