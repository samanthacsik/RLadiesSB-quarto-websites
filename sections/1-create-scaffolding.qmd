...
1.  **Create a new R project with some necessary website files.** Start by opening up RStudio and clicking on the ![A blue cube symbol with 'R' in the center is on the left. To the right are the words 'Project: (None)' in white, with a downward facing arrow, signifying a drop down menu](images/project.png){alt="A blue cube symbol with 'R' in the center is on the left. To the right are the words 'Project: (None)' in white, with a downward facing arrow, signifying a drop down menu" style="display: inline-block; margin: 0; position: relative; top: 0px; width:80px;height:18px;"} button in the top right corner. Select **New Project...**

```{r}
#| echo: false
#| fig-align: center
knitr::include_graphics(here::here("images", "vRStudio1.png"))
```
...
#| layout-ncol: 2
#| column: page
knitr::include_graphics(here::here("images", "vRStudio2.png"))
knitr::include_graphics(here::here("images", "vRStudio3.png"))
```

And finally, fill out the **Directory name:** field -- this is the name of your R project, and will eventually become your remote (i.e. GitHub) repository name ***(Important: see note below re: naming!)*** -- and choose where to save your directory to using the **Browse** button. I also recommend unchecking the **Use visual markdown editor** box, if selected (this just means you're project will open with the [Source editor](https://docs.posit.co/ide/user/ide/guide/productivity/text-editor.html){target="_blank"}, but you'll still be able to toggle to the [Visual editor](https://docs.posit.co/ide/user/ide/guide/documents/visual-editor.html){target="_blank"}, if desired). Click **Create Project**.
...
#| echo: false
#| fig-align: center
knitr::include_graphics(here::here("images", "vRStudio4.png"))
```
...
-   Your site preview should open up in your browser. Quit your preview by clicking the **Stop** button in the top right corner of your Terminal or by pressing `Ctrl` + `C`. 
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("images", "preview-R.png"))
```
...
knitr::include_graphics(here::here("images", "git-tab.png"))
```
...
Click on the **Git** tab in the top right pane of RStudio. Next to the ![A white diamond with two purple squares, one directly above and one directly to the right, connected to the diamond by a line.](images/branch.png){style="display: inline-block; margin: 0; position: relative; top: 0px; width:20px;height:18px;"} symbol, you should see a dropdown menu that displays the name of your current branch.
...
Confirm that your branch name was updated to `main` by running `git branch` or `git status` in your Terminal. The above function only updates your default branch name for *this* respository. **You'll also want to update your git config file so that the default branch name of any future local git repository is automatically named `main`.**  To do so, run:
